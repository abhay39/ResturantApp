    ...
    return (
        ...
        <StatusBar backgroundColor="#F76545" barStyle="light-content" />
          <View style={{flexDirection:'row',margin:20}}>
              ...
              <Text style={{fontSize:20,color:'black',marginTop:10,fontWeight:'bold',marginLeft:20}}> 260 Calories</Text>
              </View>    
      <ScrollView>
        <View style={{justifyContent:'center',alignItems:'center'}}>
          <Image style={styles.imagesHeader} source={require('../images/fried.png')}/>
        </View>
        <Text style={{marginTop:-30,fontSize:40,fontWeight:'bold',color:'red',textAlign:'center'}}>Fried Chicken</Text>
        ...
        <View style={{alignItems:'center',marginTop:20}}>
            <TouchableOpacity style={{backgroundColor:'red',width:250,borderRadius:30,}}
              onPress={()=>{
                  navigation.navigate('RoastedCart')
              }}
            >
