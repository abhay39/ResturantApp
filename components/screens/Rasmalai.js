  ...
  return (
      ...
      <StatusBar backgroundColor="#F76545" barStyle="light-content" />
        <View style={{flexDirection:'row',margin:20}}>
            ...
            <Text style={{fontSize:20,color:'black',marginTop:10,fontWeight:'bold',marginLeft:20}}> 200 Calories</Text>
            </View>    
    <ScrollView>
      <View style={{justifyContent:'center',alignItems:'center'}}>
        <Image style={styles.imagesHeader} source={require('../images/ras.jpg')}/>
      </View>
      <Text style={{marginTop:30,fontSize:40,fontWeight:'bold',color:'red',textAlign:'center'}}>Rasmalai</Text>
      ...
      Rasmalai is a dessert originating from the eastern part of India as almost all the milk and cream based desserts originated in that part of India. According to one of the local sweet shops in Kolkata, this Bengali origin dessert was first made and perfected by KC Das. Although these claims are not easily verifiable..
      </Text>
    </ScrollView>
    </>
  )
