  ...
  return (
    ...
    <ScrollView>
      <View style={{justifyContent:'center',alignItems:'center'}}>
        <Image style={styles.imagesHeader} source={require('../images/5.png')}/>
      </View>
      <Text style={{marginTop:-30,fontSize:40,fontWeight:'bold',color:'red',textAlign:'center'}}>Veg Burger</Text>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-around',margin:20}}>
        ...
        <Image style={styles.ingredients} source={require('../images/8.png')}/>
      </View>
