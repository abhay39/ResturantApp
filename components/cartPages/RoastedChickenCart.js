...
const GulabJamunCart = ({navigation}) => {
    var number=1;
  return (
      <>
    <View>
      <View style={{flexDirection:'row',margin:20}}>
        ...
        <View style={{marginTop:20}}>
            <View style={{flexDirection:'row', }}>
                <View style={{marginLeft:20,backgroundColor:'gray', borderRadius:30,width:100,height:100}}>
                    <Image style={{margin:11,height:70,width:80,borderRadius:20}} source={require('../images/fried.png')}/>
                </View>
            ...
            <View style={{marginLeft:145,marginTop:-60}}>
                <Text style={{fontSize:18, color:'black'}}>
                    Chicken is a meaty bird that is raised for its meat.
                </Text>
        ...
        <View style={{marginTop:10,flexDirection:'row', justifyContent:'space-between',marginLeft:20}}>
            ...
            <Text style={{marginRight:10,fontSize:25, color:'black',fontWeight:'bold'}}>₹. 400/-</Text>
        </View>
        <View style={{marginTop:10,flexDirection:'row', justifyContent:'space-between',marginLeft:20}}>
        ...
        <View style={{marginTop:10,flexDirection:'row', justifyContent:'space-between',marginLeft:20}}>
            ...
            <Text style={{marginRight:10,fontSize:25, color:'black',fontWeight:'bold'}}>₹. 450/-</Text>
        </View>
